...
一、导言
欢迎使用“匿名水印相机”软件及相关服务（以下简称“本软件”）。本协议是您与本软件开发者之间关于使用本软件所订立的法律协议。
...
匿名水印相机（以下简称“我们”）高度重视用户的隐私和个人信息保护。本政策将向您说明我们如何收集、使用及保护您的个人信息。
...
二、信息的保存与保护
1. 本软件定位为“匿名/本地水印工具”，您拍摄的所有照片及产生的水印数据均**保存在您的手机本地存储**中，我们不会将您的照片上传至网络服务器。
